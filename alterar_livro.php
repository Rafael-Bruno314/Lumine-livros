...
<html lang="pt-br">
  ...
  <?php	
	...
	$query_mudar = mysqli_query($con,"SELECT * FROM livros");
?>
  ...
  <div class="panel panel-primary">
	...
	<form id="theForm" method="post" name="theForm" action="javascript:void%200" enctype="multipart/form-data">
		...
		<input type="text" id="trapaca_genero" onmouseenter="Maiuscula(this.id)" name="trapaca_genero" style="display: none">
		</div>
		...
		<button type="submit" class="btn btn-primary" onclick="Ajeita_citacao();Ajeita_autor();Confirma();" name="Alterar" id="Alterar" value="Alterar">Alterar</button>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
