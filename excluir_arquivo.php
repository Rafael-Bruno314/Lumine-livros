...
<html lang="pt-br">
  <head>
	...
	<script type="text/javascript" src="js/excluir_arquivo.js"></script>
   ...
   <div class="panel panel-primary">
	...
	<form id="theForm" method="post" name="theForm" action="javascript:void%200" enctype="multipart/form-data">
		...
		<div class="col-xs-6 selectContainer">
			<label for="usr">Palavra-chave:</label>
			<input type="text" class="form-control" id="palavra_chave" name="palavra_chave" readonly placeholder="Palavra chave" readonly value="">
		</div><br>
		
		<div class="col-xs-2 selectContainer">
			<select id="categoria" name="categoria" class="form-control" onChange="Add_categoria()"  readonly="readonly" tabindex="-1" aria-disabled="true" >
		...
		<b>Lido em:&nbsp&nbsp </b>
			<select id="mes_lido_arquivo" name="mes_lido_arquivo"  readonly="readonly" tabindex="-1" aria-disabled="true">
			...
			<select id="ano_lido_arquivo" name="ano_lido_arquivo"  readonly="readonly" tabindex="-1" aria-disabled="true" >
