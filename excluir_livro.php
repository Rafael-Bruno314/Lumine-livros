...
<html lang="pt-br">
  <head>
	...
	<script type="text/javascript" src="js/excluir_livro.js"></script>
  ...
  <div class="container">
	...
	<form id="theForm" method="post" name="theForm" action="javascript:void%200" enctype="multipart/form-data">
		...
		<select id="titulo_mudar" name="titulo_mudar" class="form-control" onChange="loadDoc(myFunction)">
			...
			<?php while($titulo_muda = mysqli_fetch_array($query_obra_origem)) { ?>
		...
		<select id="genero" name="genero" readonly="readonly" tabindex="-1" aria-disabled="true" class="form-control" onChange="Add_genero()">
		...
		<div class="col-xs-2 selectContainer">
			<select id="status" name="status" class="form-control" readonly="readonly" tabindex="-1" aria-disabled="true" >
		...
		<div class="col-xs-3">
			<input type="text" class="form-control" readonly id="editora" name="editora" placeholder="Editora" value="">
		</div><br><br><br>
		
		<b>Lido em:&nbsp&nbsp </b>
			<select id="mes_lido_livro" name="mes_lido_livro"  readonly="readonly" tabindex="-1" aria-disabled="true" >
			...
			<select id="ano_lido_livro" name="ano_lido_livro"  readonly="readonly" tabindex="-1" aria-disabled="true" >
