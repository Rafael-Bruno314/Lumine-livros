...
<html lang="pt-br">
  <head>
    ...
    <title>Alterar Capítulos</title>
	<link rel="icon" href="icon.ico">
    <link href="css/bootstrap.min.css" rel="stylesheet">
	<script type="text/javascript" src="js/bibliotecaAjax.js"></script>
	<script type="text/javascript" src="js/bibliotecaAjax_cap.js"></script>
	<script type="text/javascript" src="js/alterar_capitulo.js"></script>
...
?>
  ...
  <div class="panel panel-primary">
	...
	<form id="theForm" method="post" name="theForm" action="javascript:void%200" enctype="multipart/form-data">
		...
		<button type="submit" onclick="Ajeita_citacao();Confirma();" name="alterar" id="alterar" class="btn btn-primary" value="Alterar">Alterar</button>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
