...
<html lang="pt-br">
  <head>
    ...
    <title>Alterar Textos ou Vídeos da Internet</title>
	<link rel="icon" href="icon.ico">
    <link href="css/bootstrap.min.css" rel="stylesheet">
	<script type="text/javascript" src="js/bibliotecaAjax.js"></script>
	<script type="text/javascript" src="js/alterar_texto.js"></script>
  ...
  <div class="container">
   <div class="panel panel-primary">
	...
	<form id="theForm" method="post" name="theForm" action="javascript:void%200" enctype="multipart/form-data">
		...
		<button type="submit" onclick="Ajeita_citacao();Ajeita_autor();Confirma();" name="buscar" id="buscar" class="btn btn-primary" value="Alterar">Alterar</button>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
