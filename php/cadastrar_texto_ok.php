<?php
	...
	$sql = "INSERT INTO textos(titulo,formato,autor,ano_publicacao,mes_lido,ano_lido,notas,citacao,pasta,link) VALUES ('$titulo','$formato','$autores','$ano_pub','$mes_lido_texto','$ano_lido_texto','$notas','$citacoes','$pasta','$link')";
