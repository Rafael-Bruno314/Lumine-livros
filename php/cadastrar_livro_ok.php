<?php
	...
	$sql = "INSERT INTO livros(titulo,autor,genero,editora,ano_publicacao,mes_lido,ano_lido,notas,citacao,status,pasta,resumo,link) VALUES ('$titulo','$autores','$genero','$editora','$ano_pub','$mes_lido_livro','$ano_lido_livro','$notas','$citacoes','$status','$pasta','$resumo','$link')";
