...
<html lang="pt-br">
  <head>
    ...
    <title>Cadastrar Arquivo</title>
	<link rel="icon" href="icon.ico">
    <link href="css/bootstrap.min.css" rel="stylesheet">
	<script type="text/javascript" src="js/bibliotecaAjax.js"></script>
	<script type="text/javascript" src="js/cadastrar_arquivo.js"></script>
...
?>
  ...
  <div class="panel panel-primary">
	...
	<form id="theForm" method="post" name="theForm" action="javascript:void%200" enctype="multipart/form-data">
		...
		<button type="submit" class="btn btn-primary" onclick="Ajeita_citacao();Ajeita_autor();Ajeita_palavra_chave();Confirma();" name="buscar" id="buscar" class="btn btn-primary" value="Cadastrar">Cadastrar</button>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
